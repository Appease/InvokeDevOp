...
[string]$OutputDirectory){
    # init working dir
    $workingDirPath = "$env:TEMP\Posh-CI-InvokeCiPlan-Build-Chocolatey"
    ...
    $nuspecFilePath = "$workingDirPath\posh-ci-invokeciplan.nuspec"
...
[string]$OutputDirPath){
    ...
    $compiledPowerShellModuleDirPath = "$OutputDirPath\Posh-CI-InvokeCiPlan"
...
[string]$SourceDirPath = "$PSScriptRoot\..\Src"){
    ...
    $compilerOutputDir = "$env:TEMP\Posh-CI-InvokeCiPlan-Compiler-Output"
